            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        ...
                        <p class="mt-3 fs-15 fw-medium">Salesman Registration</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card mt-4 card-bg-fill">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">Create Salesman Account</h5>
                                <p class="text-muted">Register a new Salesman</p>
                            </div>
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('admin.salesmen.store') }}" method="POST">
                                    ...
                                    <!-- Assign DEO -->
                                    <div class="mb-3">
                                        <label class="form-label">Assign to DEO *</label>
